...
static ConVar mat_disable_character_shader( "mat_disable_character_shader", "0", FCVAR_ARCHIVE, "Makes Character shader automatically fallback to VertexLitGeneric" );
